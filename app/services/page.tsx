...
export const metadata: Metadata = {
  ...
  description: 'Comprehensive supply chain services including inventory management, global logistics, warehousing, and supply chain analytics. Tailored solutions for your business.',
};
      ...
      <section className="bg-blue-600 text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xl text-blue-100 max-w-3xl">
            Comprehensive supply chain solutions designed to optimize your operations and drive growth
          </p>
        </div>
      </section>
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="space-y-20">
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <div className="bg-gradient-to-br from-blue-50 to-slate-100 rounded-2xl p-8 h-96 flex items-center justify-center">
                <div className="text-center text-slate-400">
                  [Image: Inventory dashboard visualization]
                </div>
              </div>
            </div>
            ...
            {/* Global Logistics */}
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div className="order-2 md:order-1 bg-gradient-to-br from-blue-50 to-slate-100 rounded-2xl p-8 h-96 flex items-center justify-center">
                <div className="text-center text-slate-400">
                  [Image: Global shipping network map]
                </div>
              </div>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <div className="bg-gradient-to-br from-blue-50 to-slate-100 rounded-2xl p-8 h-96 flex items-center justify-center">
                <div className="text-center text-slate-400">
                  [Image: Analytics charts and graphs]
                </div>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 lg:grid-cols-6 gap-6">
            {['Retail', 'E-commerce', 'Manufacturing', 'Healthcare', 'Food & Beverage', 'Automotive'].map((industry) => (
              <div key={industry} className="bg-slate-50 p-6 rounded-lg text-center border border-slate-200 hover:border-blue-600 hover:shadow-md transition-all">
